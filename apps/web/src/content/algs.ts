import { AlgDatasetSchema, SwapDatasetSchema, SwapParityDatasetSchema, M2OpParityDatasetSchema, OpParityDatasetSchema, OpSetupsDatasetSchema, type AlgDataset, type SwapDataset, type SwapParityDataset, type M2OpParityDataset, type OpParityDataset, type OpSetupsDataset } from "@bld/cube-engine";
...
let cache: { threeStyleCorners: AlgDataset; threeStyleEdges: AlgDataset; opCorners: OpSetupsDataset; opEdges: OpSetupsDataset; opParity: OpParityDataset; m2Edges: SwapDataset; m2opParity: M2OpParityDataset; r2Wings: SwapDataset; u2Centres: SwapDataset; r2Parity: SwapParityDataset } | undefined;
