...
export function MemoryWorkspace() {
  ...
  return <div className="memory-workbench">
    ...
    <section className="flex flex-col gap-4" aria-label={copy.memory.palace} data-guide="memory-palace">
    ...
    <section className="flex flex-col gap-4 border-t border-rule pt-6" aria-label={copy.memory.pairs} data-guide="memory-pairs"><h2 className="t-heading">{copy.memory.pairs}</h2>
    ...
    <section className="flex flex-col gap-4 border-t border-rule pt-6" aria-label={copy.memory.story} data-guide="memory-story"><h2 className="t-heading">{copy.memory.story}</h2>
