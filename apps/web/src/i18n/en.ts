...
export const en = {
  ...
  learn: {
    ...
    trackCfopIntro: "Already solve with the beginner method? Start here with notation and paired F2L insertions. This independent path does not require blindfolded lessons. Last-layer and advanced F2L sections are still being built.",
