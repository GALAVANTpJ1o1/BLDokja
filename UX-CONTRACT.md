...
Real iOS/Android virtual-keyboard checks and physical-cube verification remain manual. Earlier mobile Lighthouse lesson/3-style scores (~77/78) remain below BRIEF's 95 target. Automated browser engines are not physical-device evidence. CFOP and navigation-pattern work are pending, not completed by this contract.
