 ...
 * the input to Gate B. It chooses nothing itself; the Gate B choices are recorded in D-022.
 *
...
Generated by \`pnpm engine:report buffers\` as the input to Gate B. **It chooses nothing itself.** The defaults were chosen from it at Gate B (D-022), and the datasets in \`content/algs/3x3/\` are generated for those choices. Buffers are named by piece, with the orientation-reference sticker used as the buffer sticker (D-009, D-012).
